...
#+END_src 
 ...
 + Define a synchronous message with retrun value as a string in format: '==>' <object name> '.' <message label> '/' <return label>
 + Define a asynchronous message as a string in format: '-->' <object name> '.' <message label>
