...
#+END_src 
 ...
 + Define a synchronous message with retrun value in a formated string : '==>' <object name> '.' <message label> '/' <return label>
 + Define a asynchronous message in a formated string: '-->' <object name> '.' <message label>
 + Define a new message in a fromated string : 'n->' <object> '.' <object name > '.' <mesasge label>
 + Any object name begin with '!' is a active object
 + Define a sequence list of messages in macro '&prog'
 + Define a message with follwing sub-messages in mcaro '&chain'
 + Define a optional/alternative frame with guard condtion and  messages in macro '&opt' or '&if'
 + Define a loop frame with guard and message in macro '&loop'
